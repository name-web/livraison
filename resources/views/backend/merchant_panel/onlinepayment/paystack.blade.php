    ...
    <div class="wc-card">
        <div class="wc-card-header">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="wc-card-title">{{ __('levels.paystack_payout_details') }}</h3>
                    <p class="text-[12px] text-wc-muted m-0">Paiement via Paystack</p>
                </div>
            </div>
        </div>
        <div class="p-4 sm:p-5">
            <form action="{{route('online.payment.paystack.initialize.payment')}}" method="get">
                ...
                <div class="flex items-center gap-2 flex-wrap mt-1.5">
                    <input type="number" name="amount" id="amount" class="wc-input flex-1 min-w-[160px]" placeholder="0.00" />
