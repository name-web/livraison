            ...
            <form action="{{route('merchant-panel.shops.update',$shop->id)}}" method="POST" enctype="multipart/form-data" id="basicform">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="wc-form-group m-0">
                        ...
                        <input id="contact" type="tel" name="contact_no" data-parsley-trigger="change" placeholder="07 01 02 03 04" autocomplete="off" inputmode="numeric" maxlength="10" class="wc-input" value="{{$shop->contact_no}}" required>
