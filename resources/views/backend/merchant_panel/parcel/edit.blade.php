...
@section('maincontent')
    <div class="container-fluid dashboard-content">
        {{-- En-tête : Modifier un colis + actions --}}
        <div class="wc-page-header">
            <div>
                <h1 class="wc-page-title">
                    <i class="fas fa-pen text-[18px] mr-2 text-wc-primary"></i>
                    {{ __('parcel.edit_parcel') }}
                </h1>
                <p class="wc-page-subtitle">
                    Modifiez les informations de l'expédition puis enregistrez vos changements.
                </p>
            </div>
            <div class="flex items-center gap-2 flex-wrap">
                ...
                <button type="submit" form="basicform" class="wc-btn wc-btn-primary">
                    <i class="fas fa-save text-[12px]"></i> {{ __('levels.save_change') }}
                </button>
            </div>
        </div>
                ...
                <form action="{{ route('merchant-panel.parcel.update', $parcel) }}" method="POST"
                    ...
                    <div class="wc-card overflow-hidden">
                        <div class="wc-card-header">
                            ...
                            <div>
                                <h3 class="wc-card-title">{{ __('parcel.edit_parcel') }}</h3>
