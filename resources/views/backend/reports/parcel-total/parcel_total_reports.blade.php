                        ...
                        <div class="card card-height">
                            ...
                            <ul class="list-group m-2">
                                ...
                                <li class="list-group-item profile-list-group-item">
                                    ...
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($parcelInfo['total_created_cash_collection'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                ...
                                <li class="list-group-item profile-list-group-item">
                                    ...
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($parcelInfo['total_delivered_cash_collection'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                ...
                                <li class="list-group-item profile-list-group-item">
                                    ...
                                    <span class="float-right" id="totalCashCollection"> {{ format_money(number_format($parcelInfo['total_in_transit_cash_collection'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                ...
                                <li class="list-group-item profile-list-group-item">
                                    ...
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($parcelInfo['total_returned_to_merchant_cash_collection'],2)) }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card card-height">
                            ...
                            <ul class="list-group m-2">
                                ...
                                <li class="list-group-item profile-list-group-item">
                                    ...
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($parcelInfo['total_delivered_cod_amount'],2)) }}</span>
                                </li>
                                    <li class="list-group-item profile-list-group-item">
                                    <span class="float-left font-weight-bold">{{ __('reports.total_delivery_charge_amount')  }}  </span>
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($parcelInfo['total_delivery_charge_amount'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                    <span class="float-left font-weight-bold">{{ __('reports.total_vat_amount')  }}  </span>
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($parcelInfo['total_vat_amount'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                    <span class="float-left font-weight-bold">{{ __('reports.total') }} {{ __('reports.F./L.Charge')  }}</span>
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($parcelInfo['total_liquid_fragile_amount'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                    <span class="float-left font-weight-bold">{{ __('reports.total') }} {{ __('reports.P.Charge')  }}</span>
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($parcelInfo['total_packaging_amount'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                    <span class="float-left font-weight-bold">{{ __('reports.total') }} {{ __('reports.return_charges')  }}</span>
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($parcelInfo['total_returned_to_merchant_charges'],2)) }}</span>
                                </li>
                                ...
                                <li class="list-group-item profile-list-group-item" style="background-color: #00000014;font-weight:bold">
                                    ...
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($parcelInfo['total_charges'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                    <span class="float-left font-weight-bold"> {{ __('reports.delivery_man_income')  }}</span>
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($parcelInfo['total_deliveryman_income'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item" style="background-color: #00000014;font-weight:bold">
                                    ...
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format( $parcelInfo['total_profit'],2)) }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card card-height">
                            ...
                            <ul class="list-group m-2">
                                ...
                                <li class="list-group-item profile-list-group-item">
                                    ...
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($payabletoMerchant['payable_to_merchant'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                    <span class="float-left font-weight-bold">{{ __('reports.Total_paid_to_merchant(with Pending)')  }}</span>
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($payabletoMerchant['total_paid_to_merchant_amount'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                    <span class="float-left font-weight-bold">{{ __('reports.total_due_amount')  }}</span>
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($payabletoMerchant['total_merchant_due_amount'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                    <span class="float-left font-weight-bold">{{ __('reports.Pending_Payments')  }}</span>
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($payabletoMerchant['total_merchant_pending_payment_amount'],2)) }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card card-height">
                            ...
                            <ul class="list-group m-2">
                                ...
                                <li class="list-group-item profile-list-group-item">
                                    ...
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($bankTransaction['total_account_balance'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                    <span class="float-left font-weight-bold">{{ __('reports.total_account_opening_balance')  }}</span>
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($bankTransaction['total_account_opening_balance'],2)) }}</span>
                                </li>
                                <li class="list-group-item profile-list-group-item">
                                    <span class="float-left font-weight-bold">{{ __('reports.total_fund_transfer_amount')  }}</span>
                                    <span class="float-right" id="totalCashCollection">{{ format_money(number_format($bankTransaction['total_fund_transfer_amount'],2)) }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
