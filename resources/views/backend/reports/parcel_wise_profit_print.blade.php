                        ...
                        <table class="table   " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr   class="totalCalculationHead bg-primary" style="background-color:#5969ff">
                                    ...
                                    <td> {{ format_money($parcels->sum('total_delivery_amount')) }} </td>
                                    <td> {{ format_money(parcelExpenseTotal($parcels->pluck('id'))) }} </td>
                                    <td >  {{ format_money(($parcels->sum('total_delivery_amount') - parcelExpenseTotal($parcels->pluck('id')) )) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
