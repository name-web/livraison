                                    ...
                                    @if(isset($merchantaccounts))
                                        @foreach ($merchantaccounts as $maccounts)
                                            @if($maccounts->payment_method == 'bank')
                                                <option value='{{ $maccounts->id }}' @if($maccounts->id == $request->merchant_account) selected @endif> {{ $maccounts->holder_name  }} | {{ optional($maccounts->bank)->name }} | {{ $maccounts->account_no }} | {{ $maccounts->branch_name}}</option>
                                            @elseif($maccounts->payment_method == 'mobile'){
                                                <option value='{{ $maccounts->id }}' @if($maccounts->id == $request->merchant_account) selected @endif>{{ optional($maccounts->mobileBank)->name }} | {{ $maccounts->mobile_no }} | {{ $maccounts->account_type }}</option>
                                    ...
                                    <td>
                                        ...
                                        @if ($payment->merchantAccount !==null && $payment->merchantAccount->payment_method == 'bank')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8"> : {{ optional($payment->merchantAccount->bank)->name }} </div>
                                            </div>
                                            <div class="row">
                                        ...
                                        @elseif ($payment->merchantAccount !==null &&  $payment->merchantAccount->payment_method == 'mobile')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8"> : {{ optional($payment->merchantAccount->mobileBank)->name}} </div>
                                            </div>
                                            <div class="row">
