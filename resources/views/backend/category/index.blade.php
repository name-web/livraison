...
<!-- Data table css  -->
@push('styles')
    <link rel="stylesheet" href="{{static_asset('backend')}}/plugins/datatables/css/dataTables.bootstrap4.css">
    <link rel="stylesheet" href="{{static_asset('backend')}}/plugins/datatables/css/buttons.bootstrap4.css">
    <link rel="stylesheet" href="{{static_asset('backend')}}/plugins/datatables/css/buttons.bootstrap4.css">
    <link rel="stylesheet" href="{{static_asset('backend')}}/plugins/datatables/css/select.bootstrap4.css">
    <link rel="stylesheet" href="{{static_asset('backend')}}/plugins/datatables/css/fixedHeader.bootstrap4.css">
...
@push('scripts')
    ...
    <script src="{{static_asset('backend')}}/plugins/datatables/js/dataTables.bootstrap4.min.js"></script>
    <script src="{{static_asset('backend')}}/plugins/datatables/js/data-table.js"></script>
    <script src="{{static_asset('backend')}}/plugins/slimscroll/jquery.slimscroll.js"></script>
    <script src="{{static_asset('backend')}}/plugins/multi-select/js/jquery.multi-select.js"></script>
