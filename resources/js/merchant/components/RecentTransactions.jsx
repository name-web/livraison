...
=======
                <div className="wc-card-icon g-emerald">
...
=======
                            <div key={t.id} className="wcp-rt-row">
                                <div className={`wcp-rt-ic ${income ? 'wcp-rt-in' : 'wcp-rt-out'}`}>
>>>>>>> 7e7eef8 (feat(merchant): refonte UI dashboard + shops, formattage Pint)
                                    <i className={`fas ${income ? 'fa-arrow-up' : 'fa-arrow-down'}`}></i>
                                </div>
                                <div className="min-w-0 flex-1">
                                    <p className="wcp-rt-t truncate">
                                        {income ? 'Encaissement colis' : 'Paiement livraison'}
                                    </p>
                                    <p className="wcp-rt-s truncate">
                                        {t.tracking_id ? (
...
=======
                                    <p className={`wcp-rt-amt ${income ? 'in' : 'out'}`}>
>>>>>>> 7e7eef8 (feat(merchant): refonte UI dashboard + shops, formattage Pint)
...
=======
                    <div className="w-12 h-12 rounded-full flex items-center justify-center mb-3" style={{ background: 'var(--wc-surface-soft)', color: '#94a3b8' }}>
>>>>>>> 7e7eef8 (feat(merchant): refonte UI dashboard + shops, formattage Pint)
