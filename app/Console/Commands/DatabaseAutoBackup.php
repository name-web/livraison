...
class DatabaseAutoBackup extends Command
{
    ...
    public function handle()
    {
        ...
        $connect = new \PDO("mysql:host=$mysqlHostName;dbname=$DbName;charset=utf8", "$mysqlUserName", "$mysqlPassword",array(\Pdo\Mysql::ATTR_INIT_COMMAND => "SET NAMES 'utf8'"));
        ...
        try {
            Mail::raw('Database backup attached.', function ($message) use ($output,$file_name) {
            ...
            // If mail fails, log error but continue
