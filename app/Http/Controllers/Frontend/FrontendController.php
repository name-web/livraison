...
class FrontendController extends Controller
{
    ...
    public function index(){ 
        ...
        $data['faqs']         = $this->faqRepo->getActive();
        
        return theme_view('home', $data);
    }

    public function tracking(Request $request){  
        $parcel         = $this->parcelRepo->parcelTracking($request);
        $parcelevents   = $this->parcelRepo->parcelEvents($parcel->id?? null);
        return theme_view('pages.tracking', compact('parcelevents', 'parcel', 'request'));
    }
    ...
    public function faq(){
        ...
        return theme_view('pages.faq', compact('page', 'faqs'));
    }
    ...
    public function contactSendPage(){
        ...
        return theme_view('pages.contact', compact('page'));
    }
