...
class PaymentAccountController extends Controller
{
    ...
    public function index(){
        ...
        try {
            ...
            $methods = (array) Config::get('merchantpayment.payment_method');
            $banks = $this->bankRepo->all();
            $mobile_banks = $this->mobileRepo->all();
            return $this->responseWithSuccess(__('account.title'), ['accounts'=>$accounts,'methods' => $methods,'mobile_banks' => $mobile_banks,'banks' => $banks], 200);
