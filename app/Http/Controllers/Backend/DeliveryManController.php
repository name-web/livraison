...
class DeliveryManController extends Controller
{
    ...
    {
        if(env('DEMO')) {
            Toastr::success(__('deliveryman.update_msg'),__('This action is not available in Demo Mode. Updating or modifying data has been disabled for demonstration purposes.'));
            return redirect()->route('deliveryman.index');
        }
