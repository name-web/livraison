...
class DeliveryMan extends Model
{
    ...
    protected $fillable = ['user_id', 'status', 'delivery_charge', 'pickup_charge', 'return_charge', 'opening_balance', 'current_balance', 'current_location_lat', 'current_location_long', 'is_available', 'current_hub_id'];
    ...
    {
        return $query->where('is_available', true)->where('status', Status::ACTIVE);
    }

    public function scopeForHub($query, int $hubId)
    {
        return $query->where('current_hub_id', $hubId);
    }
}
