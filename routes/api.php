...
use App\Http\Controllers\Api\V10\CollectionController;
...
Route::prefix('v10')->group(function () {
    ...
    Route::middleware(['CheckApiKey'])->group(function () {
        ...
        Route::group(['middleware' => ['auth:sanctum']], function () {
            ...
            Route::get('deliveryman/parcel/find/search/{tracking_id}', [DeliverymanController::class, 'parcelSearchBarCodeFind']);
            ...
            Route::post('deliveryman/parcel-status-update', [DeliverymanController::class, 'parcelStatusUpdate']);            // ─── Collection (Collecte & Livraison) ──────
            Route::post('/collection/location-update', [CollectionController::class, 'updateLocation']);
            Route::get('/collection/my-collections', [CollectionController::class, 'myCollections']);
            Route::get('/collection/{collection}', [CollectionController::class, 'show']);
            Route::post('/collection/{collection}/accept', [CollectionController::class, 'accept']);
            Route::post('/collection/{collection}/pickup-complete', [CollectionController::class, 'pickupComplete']);
            Route::post('/collection/{collection}/complete', [CollectionController::class, 'complete']);
            Route::post('/collection/cash/collect', [CollectionController::class, 'collectCash']);
            Route::post('/collection/cash/handover', [CollectionController::class, 'handOverCash']);
            Route::get('/collection/cash/summary', [CollectionController::class, 'cashSummary']);
